...
The project follows a clear end-to-end workflow: 

**Problem Understanding → Data Processing → Dashboard Visualization → Insight & Recommendation**
...
* **SQL (Python)**: Data extraction and transformation.
* **Power BI**: Dashboard creation and visualization.
* **Microsoft Word**: Reporting and documentation.

---
## Notes
* SQL is the primary and most detailed processing layer.
* Python code is included for comparison and flexibility.
* Power BI dashboards strictly follow the original problem requirements.
